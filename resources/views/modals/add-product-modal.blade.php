        ...
        <div class="modal-content rounded-3 shadow">
            <div class="modal-body p-2">
                <div class="row justify-content-center">
                    ...
                    <form action="{{ route('product.add') }}" class="px-5 py-2" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-outline mb-4">
                            <input required type="text" value="{{ @old('product-name') }}"
                                name="product-name" id="productName" class="form-control" />
                            <label class="form-label" for="productName">Product Name</label>
                        </div>
                        <div class="row mb-4">
                            <div class="col-6">
                                <div class="form-outline">
                                    <input required type="number" value="{{ @old('unit-price') }}"
                                        step=".01" placeholder="0.00" name="unit-price" id="unitPrice"
                                        class="form-control" />
