...
@section('content')
    <div class="container"> 
        ...
        <div class="row">
            <div class="d-flex">
                <div><span class="fw-semibold h6">Customer : </span>
                    <span class="form-text text-uppercase">
                        {{ $customer->name }}
                    </span>
                </div>
                <div> <span class="fw-semibold h6 ms-4">Gender : </span>
                    <span class="form-text text-capitalize">
                        {{ $customer->gender }} </span>
                </div>
                <div> <span class="fw-semibold h6 ms-4">Address : </span>
                    <span class="form-text text-capitalize">
                        {{ $customer->address }} </span>
                </div>
                <div> <span class="fw-semibold h6 ms-4">Contact : </span>
                    <span class="form-text text-capitalize">
            ...
            <table id="create-order" class="table table-bordered mb-0">
                <thead>
                    <tr class="p-3">
                        ...
                        <th class="col-md-3 p-3" scope="col" title="Price">Unit Price (GHC)</th>
                ...
                <tbody id="td-parent">
                    <tr class="form_row">
                        ...
                        <td class="col-md-3">
                            <div class="form-group">
                                <input readonly type="text" name="price[]" type="number" value="0" id="price"
