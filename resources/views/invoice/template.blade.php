...
<body>
    ...
    <div class="container">
        ...
        <div class="page-image">
            {{-- <img src="{{ asset('/logo.png') }}" width="35px" height="35px" alt="logo"> --}}
            <span> SHELL MEDYAK MR B.</span>
        </div>
        <div class="invoice-header">
            <div class="row align-end">
                <div class="flex-column">Date: {{ Carbon::parse($date->created_at)->format('Y-M-d') }}</div>
            </div>
            <div class="row align-end">
                <div class="flex-column">#Order Number : {{ $order_number->order_number }}</div>
            </div>
            <div class="row align-end">
                <div class="flex-column">#Supplier Number : {{ $invoice_number->invoice_number }}</div>
            </div>
        </div>
        <table>
            <thead>
